function lcsMatches(left, right, key = (value) => value) {
    ...
    if (!left.length || !right.length || rows * columns > 180000) return prefix.concat(suffix);
...
function renderSentencePair(leftLine, rightLine, escapeHTML) {
    if (leftLine === rightLine) return { left: escapeHTML(leftLine), right: escapeHTML(rightLine) };
